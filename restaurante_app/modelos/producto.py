class Producto:
    ...
    @calorias.setter
    def calorias(self, valor: int) -> None:
        try:
            calorias = int(valor)
        except (TypeError, ValueError):
            raise ValueError("Las calorias deben ser un numero entero.")
        if calorias < 0 or calorias > 2000:
            raise ValueError("Las calorias deben estar entre 0 y 2000 por porcion.")
    ...
    def __str__(self) -> str:
        return (
            ...
            f"Calorias: {self.calorias} kcal | Stock: {self.stock}"
        )
